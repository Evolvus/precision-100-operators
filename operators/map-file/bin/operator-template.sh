...
$PRECISION100_BIN_FOLDER/audit.sh  $0 "PRE-MAP-FILE" "$CONTAINER / $FILE_NAME" "MAP-FILE" $0 "START"
...
$PRECISION100_BIN_FOLDER/audit.sh  $0 "POST-MAP-FILE" "$CONTAINER / $FILE_NAME" "MAP-FILE" $0 "END"
