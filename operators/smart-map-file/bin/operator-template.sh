...
do
  ...
  $PRECISION100_OPERATORS_FOLDER/smart-map-file/bin/map-file-split-template.sh $TABLE_NAME $SPLIT_FILE $O_TABLE_SQL $V_O_VIEW_SQL $O_TAB_COLUMN_SQL $TRANSFORM_SQL $CONNECTION_NAME
