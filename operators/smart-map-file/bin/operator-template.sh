...
DDL_SOURCE_FILE="$SMART_MAP_FILE_WORK_FOLDER/$FILE_NAME.$MAP_FILE_FILE_SUFFIX.ddl"
JOIN_SOURCE_FILE="$SMART_MAP_FILE_WORK_FOLDER/$FILE_NAME.$MAP_FILE_FILE_SUFFIX.join"
...
O_TABLE_SQL=$SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${FILE_NAME}.sql"
O_TAB_COLUMN_SQL=$SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${FILE_NAME}-${DEFAULT_TAB_COLUMN_SUFFIX}.sql"
TRANSFORM_SQL=$SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${FILE_NAME}-${DEFAULT_TRANSFORM_SUFFIX}.sql"
