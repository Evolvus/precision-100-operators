...
TEMP_FILE_3="$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/$FILE_NAME.$MAP_FILE_FILE_SUFFIX.t3"
...
V_O_VIEW_SQL=$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_VIEW_NAME_PREFIX}_${DEFAULT_TABLE_NAME_PREFIX}-${FILE_NAME}.sql"
...
echo "        SMART-MAP-FILE ADAPTOR CREATING V_O_ VIEW SCRIPT"
$PRECISION100_OPERATORS_FOLDER/smart-map-file/bin/map-file-view.sh $FILE_NAME $DDL_SOURCE_FILE > $V_O_VIEW_SQL
