...
do
  ...
  O_TABLE_SQL=$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${SPLIT_FILE}.sql"
  V_O_VIEW_SQL=$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_VIEW_NAME_PREFIX}-${DEFAULT_TABLE_NAME_PREFIX}-${SPLIT_FILE}.sql"
  O_TAB_COLUMN_SQL=$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${DEFAULT_TAB_COLUMN_SUFFIX}-${SPLIT_FILE}.sql"
  TRANSFORM_SQL=$PRECISION100_OPERATOR_SMART_MAP_FILE_WORK_FOLDER/"${DEFAULT_TABLE_NAME_PREFIX}-${DEFAULT_TRANSFORM_SUFFIX}-${SPLIT_FILE}.sql"
